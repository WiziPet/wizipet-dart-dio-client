...
class FrontHistoriqueApi {
  ...
  const FrontHistoriqueApi(this._dio, this._serializers);
  ...
  Future<Response<ListResponseSantesHistoriqueDto>> apiV1FrontProfilePetIdHistoriquesActiviteGet({ 
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/historiques/activite'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString());
  ...
  Future<Response<ListResponseSantesHistoriqueDto>> apiV1FrontProfilePetIdHistoriquesAlimentationsGet({ 
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/historiques/alimentations'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ListResponseSantesHistoriqueDto>> apiV1FrontProfilePetIdHistoriquesPoidsGet({ 
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/historiques/poids'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
