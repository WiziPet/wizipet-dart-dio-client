...
class FrontContactApi {
  ...
  const FrontContactApi(this._dio, this._serializers);
  ...
  Future<Response<WpResponseSystemInt32>> apiV1FrontProfilePetIdContactCountPendingGet({ 
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/contact/count-pending'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ResumableListResponsePublicationsPublicationItemDto>> apiV1FrontProfilePetIdContactPublicationsGet({ 
    required String petId,
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/contact/publications'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<WpListResponseContactsContactSummaryDto>> apiV1FrontProfilePetIdContactSummaryGet({ 
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/contact/summary'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponse>> apiV1FrontProfilePetIdContactTargetProfileIdDelete({ 
    required String petId,
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/contact/{target_profile_id}'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString()).replaceAll('{' r'target_profile_id' '}', encodeQueryParameter(_serializers, targetProfileId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [WpResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponse>> apiV1FrontProfilePetIdContactTargetProfileIdPut({ 
    required String petId,
    required String targetProfileId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
