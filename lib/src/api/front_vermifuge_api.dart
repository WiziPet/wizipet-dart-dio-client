...
class FrontVermifugeApi {
  ...
  const FrontVermifugeApi(this._dio, this._serializers);
  ...
  Future<Response<ListResponseSantesMedicamentationItemDto>> apiV1FrontProfilePetIdSantesVermifugesMedicamentationsGet({ 
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/santes/vermifuges/medicamentations'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponse>> apiV1FrontProfilePetIdSantesVermifugesMedicamentationsMedicamentationIdPatch({ 
    required String petId,
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/santes/vermifuges/medicamentations/{medicamentation_id}'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString()).replaceAll('{' r'medicamentation_id' '}', encodeQueryParameter(_serializers, medicamentationId, const FullType(String)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponseCreateReplyDto>> apiV1FrontProfilePetIdSantesVermifugesMedicamentationsPost({ 
    required String petId,
    SantesSetMedicamentationDto? santesSetMedicamentationDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  Future<Response<ListResponseVermifugesVermifugeDto>> apiV1FrontVermifugesGet({ 
    ...
    final _path = r'/api/v1/front/vermifuges';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
