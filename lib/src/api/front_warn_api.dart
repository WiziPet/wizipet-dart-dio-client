...
class FrontWarnApi {
  ...
  const FrontWarnApi(this._dio, this._serializers);
  ...
  Future<Response<ListResponseWarnsWarnItemDto>> apiV1FrontProfilePetIdWarnsGet({ 
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/warns'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponse>> apiV1FrontProfilePetIdWarnsWarnIdDelete({ 
    required String petId,
    required String warnId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/warns/{warn_id}'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString()).replaceAll('{' r'warn_id' '}', encodeQueryParameter(_serializers, warnId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
