...
import 'package:wizipet_api/src/model/cartes_list_profiles_param_dto.dart';
...
import 'package:wizipet_api/src/model/wp_response_cartes_place_details_dto.dart';
import 'package:wizipet_api/src/model/wp_response_cartes_position_dto.dart';
import 'package:wizipet_api/src/model/wp_response_create_reply_dto.dart';
import 'package:wizipet_api/src/model/wp_response_system_bytes.dart';
...
class FrontCarteApi {
  ...
  const FrontCarteApi(this._dio, this._serializers);
  ...
  Future<Response<ListResponsePlacesAnimauteLocalPageItemDto>> apiV1FrontCartesAnimauteLocalPagesPost({ 
    ...
    final _path = r'/api/v1/front/cartes/animaute/local_pages';
    ...
    try {
      const _type = FullType(PlacesListPlacesFromBoundsDto);
      _bodyData = placesListPlacesFromBoundsDto == null ? null : _serializers.serialize(placesListPlacesFromBoundsDto, specifiedType: _type);
  ...
  Future<Response<ListResponsePlacesExpediaHotelItemDto>> apiV1FrontCartesExpediaHotelsPost({ 
    ...
    final _path = r'/api/v1/front/cartes/expedia/hotels';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PlacesListExpediaHotelSearchDto);
      _bodyData = placesListExpediaHotelSearchDto == null ? null : _serializers.serialize(placesListExpediaHotelSearchDto, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WpResponseCartesGeocodeResultsDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponseCartesGeocodeResultsDto>> apiV1FrontCartesGeocodeGet({ 
    String? address,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/front/cartes/geocode';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    WpResponseCartesGeocodeResultsDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(WpResponseCartesGeocodeResultsDto),
      ) as WpResponseCartesGeocodeResultsDto;
    ...
    return Response<WpResponseCartesGeocodeResultsDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ListResponseCartesPetItemDto>> apiV1FrontCartesPetsPerdusPost({ 
    ...
    final _path = r'/api/v1/front/cartes/pets/perdus';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CartesListProfilesParamDto);
      _bodyData = cartesListProfilesParamDto == null ? null : _serializers.serialize(cartesListProfilesParamDto, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WpResponseCartesPetFriendlyPlaceDetailsDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponseCartesPetFriendlyPlaceDetailsDto>> apiV1FrontCartesPlacesPetFriendlyPlaceIdGet({ 
    ...
    final _path = r'/api/v1/front/cartes/places/pet_friendly/{place_id}'.replaceAll('{' r'place_id' '}', encodeQueryParameter(_serializers, placeId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    WpResponseCartesPetFriendlyPlaceDetailsDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(WpResponseCartesPetFriendlyPlaceDetailsDto),
      ) as WpResponseCartesPetFriendlyPlaceDetailsDto;
    ...
    return Response<WpResponseCartesPetFriendlyPlaceDetailsDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ListResponseCartesPetFriendlyLocationItemDto>> apiV1FrontCartesPlacesPetFriendlyPost({ 
    ...
    final _path = r'/api/v1/front/cartes/places/pet_friendly';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WpResponseCartesPlaceDetailsDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponseCartesPlaceDetailsDto>> apiV1FrontCartesPlacesPlaceIdGet({ 
    required String placeId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/front/cartes/places/{place_id}'.replaceAll('{' r'place_id' '}', encodeQueryParameter(_serializers, placeId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    WpResponseCartesPlaceDetailsDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(WpResponseCartesPlaceDetailsDto),
      ) as WpResponseCartesPlaceDetailsDto;
    ...
    return Response<WpResponseCartesPlaceDetailsDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ListResponsePlacesPlaceItemDto>> apiV1FrontCartesPlacesPost({ 
    ...
    final _path = r'/api/v1/front/cartes/places';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PlacesListPlacesDto);
      _bodyData = placesListPlacesDto == null ? null : _serializers.serialize(placesListPlacesDto, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WpResponseCartesPositionDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponseCartesPositionDto>> apiV1FrontCartesPositionGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/front/cartes/position';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    WpResponseCartesPositionDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(WpResponseCartesPositionDto),
      ) as WpResponseCartesPositionDto;
    ...
    return Response<WpResponseCartesPositionDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [height] 
  /// * [aspect] 
  /// * [lat] - Position sur le référentiel nord-sud.
  /// * [lng] - Position sur un référentiel est-ouest.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WpResponseSystemBytes] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponseSystemBytes>> apiV1FrontCartesPositionImageGet({ 
    int? width,
    int? height,
    MediasImageAspectDto? aspect,
    double? lat,
    double? lng,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/front/cartes/position/image';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (aspect != null) r'aspect': encodeQueryParameter(_serializers, aspect, const FullType(MediasImageAspectDto)),
    ...
    WpResponseSystemBytes? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(WpResponseSystemBytes),
      ) as WpResponseSystemBytes;
    ...
    return Response<WpResponseSystemBytes>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponse>> apiV1FrontCartesPositionPut({ 
    CartesPutPositionDto? cartesPutPositionDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CartesPutPositionDto);
      _bodyData = cartesPutPositionDto == null ? null : _serializers.serialize(cartesPutPositionDto, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [WpResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponse>> apiV1FrontCartesSharedPositionAllowedPatch({ 
    bool? sharedPositionAllowed,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/front/cartes/shared_position_allowed';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (sharedPositionAllowed != null) r'shared_position_allowed': encodeQueryParameter(_serializers, sharedPositionAllowed, const FullType(bool)),
    };
  ...
  Future<Response<ListResponseCartesUserItemDto>> apiV1FrontCartesUsersPost({ 
    ...
    final _path = r'/api/v1/front/cartes/users';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CartesListUsersParamDto);
      _bodyData = cartesListUsersParamDto == null ? null : _serializers.serialize(cartesListUsersParamDto, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [WpResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponse>> apiV1FrontProfilePetIdCartesPlacesPetFriendlyPlaceIdDelete({ 
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/cartes/places/pet_friendly/{place_id}'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString()).replaceAll('{' r'place_id' '}', encodeQueryParameter(_serializers, placeId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponseCreateReplyDto>> apiV1FrontProfilePetIdCartesPlacesPetFriendlyPlaceIdPatch({ 
    required String petId,
    required String placeId,
    CartesPostPetFriendlyLocationParamDto? cartesPostPetFriendlyLocationParamDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CartesPostPetFriendlyLocationParamDto);
      _bodyData = cartesPostPetFriendlyLocationParamDto == null ? null : _serializers.serialize(cartesPostPetFriendlyLocationParamDto, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [WpResponseCreateReplyDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponseCreateReplyDto>> apiV1FrontProfilePetIdCartesPlacesPetFriendlyPlaceIdPost({ 
    required String petId,
    required String placeId,
    double? starRating,
    CancelToken? cancelToken,
    ...
    final _queryParameters = <String, dynamic>{
      if (starRating != null) r'star_rating': encodeQueryParameter(_serializers, starRating, const FullType(double)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [WpResponseCreateReplyDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WpResponseCreateReplyDto>> apiV1FrontProfilePetIdCartesPlacesPetFriendlyPost({ 
    required String petId,
    CartesPostPetFriendlyLocationParamDto? cartesPostPetFriendlyLocationParamDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/front/profile/{pet_id}/cartes/places/pet_friendly'.replaceAll('{' r'pet_id' '}', encodeQueryParameter(_serializers, petId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
