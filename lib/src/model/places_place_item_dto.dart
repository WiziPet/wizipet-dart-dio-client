...
part 'places_place_item_dto.g.dart';
...
/// * [subCategoryList] 
@BuiltValue()
abstract class PlacesPlaceItemDto implements Built<PlacesPlaceItemDto, PlacesPlaceItemDtoBuilder> {
  ...
  PlacesPlaceItemDto._();

  factory PlacesPlaceItemDto([void updates(PlacesPlaceItemDtoBuilder b)]) = _$PlacesPlaceItemDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PlacesPlaceItemDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PlacesPlaceItemDto> get serializer => _$PlacesPlaceItemDtoSerializer();
}

class _$PlacesPlaceItemDtoSerializer implements PrimitiveSerializer<PlacesPlaceItemDto> {
  @override
  final Iterable<Type> types = const [PlacesPlaceItemDto, _$PlacesPlaceItemDto];

  @override
  final String wireName = r'PlacesPlaceItemDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PlacesPlaceItemDto object, {
  ...
  void _deserializeProperties(
    ...
    required PlacesPlaceItemDtoBuilder result,
  ...
  @override
  PlacesPlaceItemDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PlacesPlaceItemDtoBuilder();
