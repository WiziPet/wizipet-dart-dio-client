...
part 'santes_set_info_dto.g.dart';
...
/// * [valeurReferenceList] 
@BuiltValue()
abstract class SantesSetInfoDto implements Built<SantesSetInfoDto, SantesSetInfoDtoBuilder> {
  ...
  SantesSetAlimentDto? get valeurAliment;
  ...
  BuiltSet<String>? get valeurReferenceList;

  SantesSetInfoDto._();

  factory SantesSetInfoDto([void updates(SantesSetInfoDtoBuilder b)]) = _$SantesSetInfoDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SantesSetInfoDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SantesSetInfoDto> get serializer => _$SantesSetInfoDtoSerializer();
}

class _$SantesSetInfoDtoSerializer implements PrimitiveSerializer<SantesSetInfoDto> {
  @override
  final Iterable<Type> types = const [SantesSetInfoDto, _$SantesSetInfoDto];

  @override
  final String wireName = r'SantesSetInfoDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SantesSetInfoDto object, {
    ...
    if (object.valeurAliment != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(SantesSetAlimentDto),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required SantesSetInfoDtoBuilder result,
  ...
  @override
  SantesSetInfoDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SantesSetInfoDtoBuilder();
